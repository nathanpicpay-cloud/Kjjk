...
export const INITIAL_PRODUCTS: Product[] = [
  ...
  {
    id: '5',
    name: 'Pulseira Imperador Cravejada Royal - Ouro 18K',
    description: 'Aqui não tem conversa: essa pulseira é peça de respeito máximo, o verdadeiro símbolo de conquista e poder do homem. A Pulseira Imperador Bodin tem design robusto e elos cravejados com micro-zircônias da mais alta pureza que brilham igual diamante. Banhada a ouro 18K, é feita para chegar chegando onde quer que você vá.',
    price: 249.90,
    ...
    length: ['19cm', '21cm'],
    thickness: '8mm',
    clasp: ['Fecho Gaveta de Dupla Trava'],
    ...
    reviews: [
      {
        ...
        author: 'Arthur Reis',
        rating: 5,
        text: 'Simplesmente a pulseira mais imponente que já tive. O brilho das pedras à noite sob luz artificial é inacreditável. Encaixe perfeito no pulso.',
        date: '15/07/2026',
        verifiedPurchase: true
      }
    ],
