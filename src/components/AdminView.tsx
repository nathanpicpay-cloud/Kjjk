...
export default function AdminView({
  ...
  const [bannersList, setBannersList] = useState(() => {
    return settings.homepageBanners || [
      { id: 'banner-1', image: 'https://i.imgur.com/0md8PSt.jpg', title: 'Use Bodin e fique chique ', subtitle: 'Ande alinhado com a presença imponente das joias em Moeda Antiga banhadas em Ouro 18K. Idênticas ao ouro maciço no peso e brilho.', tag: 'Presença e Status', linkView: 'catalog', active: true }
    ];
  });
